...
本项目基于 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 与 [ComfyUI Frontend](https://github.com/Comfy-Org/ComfyUI_frontend) 开发，并依据 **GNU General Public License v3.0（GPL-3.0）** 开源。
...
This project is derived from [ComfyUI](https://github.com/comfyanonymous/ComfyUI) and [ComfyUI Frontend](https://github.com/Comfy-Org/ComfyUI_frontend), and is released under the **GNU General Public License v3.0 (GPL-3.0)**.
