...
parser.add_argument(
    "--minimax-design-api-base",
    type=str,
    default=None,
    help="Base URL of the MiniMax design gateway used by the MiniMax H3 prompt expansion node "
    "(e.g. https://hub-pre.xaminim.com). Falls back to the MINIMAX_DESIGN_API_BASE env var.",
)
