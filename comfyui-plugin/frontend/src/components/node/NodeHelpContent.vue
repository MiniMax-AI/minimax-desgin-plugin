<template>
  <div class="node-help-content mx-auto w-full">
    ...
    <div
      v-if="renderedPriceDescriptionHtml"
      class="markdown-content overflow-visible text-sm leading-(--text-sm--line-height)"
      v-html="renderedPriceDescriptionHtml"
    />
  </div>
</template>
...
const { renderedHelpHtml, renderedPriceDescriptionHtml, isLoading, error } =
  useNodeHelpContent(() => node)
