<template>
  <div
    class="comfyui-body grid size-full overflow-hidden"
    :class="{ 'comfyui-body--graph-preview': isHubGraphPreview }"
  >
    ...
    <template v-if="isBuilderMode && !isHubGraphPreview">
      <BuilderToolbar />
      <BuilderMenu />
...
import { useHubGraphPreview } from '@/hub/useHubGraphPreview'
...
.comfyui-body--graph-preview {
  grid-template-columns: 1fr;
  grid-template-rows: 1fr;
}

.comfyui-body--graph-preview .comfyui-body-top,
.comfyui-body--graph-preview .comfyui-body-left,
.comfyui-body--graph-preview .comfyui-body-right,
.comfyui-body--graph-preview .comfyui-body-bottom {
  display: none;
}

.comfyui-body--graph-preview .graph-canvas-container {
  grid-column: 1;
  grid-row: 1;
}
